...
package org.grits.toolbox.tools.glycanbuilder.core.io.parser;
...
/**
 * Read and write glycan structures in the GlycoWorkbench internal format.
 * 
...
public class GWSParser implements GlycanParser {
	...
	static {
		...
		residue_pattern = Pattern.compile("(?:" + start_repeat_str + ")|(?:" + end_repeat_str + ")|" + "(?:"
				+ residue_str + "(?:" + cleaved_str + ")?+)" + "(?:" + place_str + ")?+" + "(?:" + cord_str + ")?");
	}
	...
	/**
	 * Create a unique representation of a glycan structure using the lexical
	 * ordering between the children of each residue.
	 */
	...
	/**
	 * Static method for creating string representation of glycan structures.
	 * 
	 * @param structure
	 ...
	 *            the structure to be converted
	 * @param ordered
	 *            <code>true</code> if the representation must use the lexical
	 ...
	 *            ordering between children
	 * @param add_massopt
	 *            <code>true</code> if the representation must contain the mass
	 *            options
	 */
	 ...
	 * 
	 * @param str the string representation of glycan
	 * @param default_mass_options
	...
	static public Glycan fromString(String str, MassOptions default_mass_options) throws Exception {
		...
		if (ind2 == -1)
			...
			ret = new Glycan(readSubtree(str.substring(0, ind2), true), readSubtree(str.substring(ind2), true), false,
					mass_opt);
		}
	...
	static public String writeSubtree(Residue r, boolean ordered, BBoxManager bboxManager) {
		...
		if (bboxManager != null && bboxManager.getBorder(r) != null) {
			Rectangle rec = bboxManager.getBorder(r);
	...
	static public Residue readSubtree(String str, boolean accept_empty, ResidueHolder startRep) throws Exception {
		...
		if (str.charAt(0) == '}') {
			...
			if (m.group(9) != null && m.group(10) != null && m.group(11) != null && m.group(12) != null) {
				ret.setCenterPosition(new java.awt.Rectangle(Integer.parseInt(m.group(9)), Integer.parseInt(m.group(10)),
