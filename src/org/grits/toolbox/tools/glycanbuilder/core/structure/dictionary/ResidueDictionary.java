...
/**
 * The dictionary of all residue types available in the application. Information
 * about residue types is loaded at run time from a configuration file. The
 * dictionary is a singleton and all information has class-wide access.
 * 
 * @see Residue
 * @see ResidueType
...
public class ResidueDictionary {
	...
	static {
		...
		all_residues_map = new HashMap<String, List<ResidueType>>();
	...
	private static List<String> superclasses;
	private static TreeMap<Integer, ResidueType> direct_residues;
	private static List<ResidueType> other_residues;
	private static List<ResidueType> all_residues;
	private static HashMap<String, List<ResidueType>> all_residues_map;
	 ...
	 * @see ResidueType
	 * @throws Exception
	 *             if there is no residue type with such a name
	 */
	...
	/**
	 * Return <code>true</code> if a residue type with such a name exists.
	 * 
	 * @see ResidueType
	 */
	...
	/**
	 * Return the residue type with the given name or <code>null</null> otherwise
	 * 
	 * @see ResidueType
	 */
	...
	/**
	 * Return the collection of all residue types in a specific class.
	 */
	...
	public static Collection<ResidueType> getReducingEnds() {
		List<ResidueType> ret = new LinkedList<ResidueType>();
	...
	/**
	 * Return the collection of all names of reducing end marker types.
	 */
	 ...
	 * 
	 * @throws Exception
	 *             if no residue type with the specified name exists
	 */
