...
/**
 * The dictionary of the residue styles available in the application for a
 * certain cartoon notation. Information about residue styles is loaded at run
 * time from a configuration file. There is a single dictionary for each
 * notation. The style dictionaries are stored in the workspace and passed to
 * the renderers.
 * 
 * @see ResidueStyleSWT
 * 
...
public class ResidueStyleDictionary {
	...
	/**
	 * Return the residue style for a specific residue, or a default one (text
	 * representation only) if none is found.
	 * 
	 * @param node
	 *            the residue for which the style should be retrieved, the type name
	 *            is used to identify the style
	 * @see ResidueStyleSWT
	 */
	...
	/**
	 * Return an iterator of all residue styles contained in the dictionary.
	 */
